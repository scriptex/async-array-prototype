...
extend('forEachAsync', forEachAsync);
extend('everyAsync', everyAsync);
extend('someAsync', someAsync);
extend('filterAsync', filterAsync);
extend('findAsync', findAsync);
extend('findIndexAsync', findIndexAsync);
extend('mapAsync', mapAsync);
